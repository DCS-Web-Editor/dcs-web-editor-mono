...
********************************/
let renderContainer;
export function createScreenshotControl(_renderContainer) {
...
function takeScreenshot() {
    ...
    setTimeout(() => {
        ...
        const options = {
            allowTaint: true,
            ignoreElements: (e) => {
                if (e === document.querySelector(".leaflet-control-container"))
                    return true;
                if (e === document.querySelector("#REDISTRIBUTE"))
                    return true;
                if (e === document.querySelector("#colorpicker"))
                    return true;
                return false;
            },
            // canvas,
