...
L.Control.Ruler = L.Control.extend({
    ...
    _toggleMeasure: function () {
        ...
        if (this._choice) this._map.dragging.disable();
        ...
        if (this._choice) {
            ...
            this._map.on("mousedown", this._clicked, this);
            ...
            this._map.off("mousedown", this._clicked, this);
    ...
    _clicked: function (e) {
        ...
        if (
            this._clickCount > 0 &&
            !e.latlng.equals(
                this._clickedPoints[this._clickedPoints.length - 2]
            )
        ) {
...
export const rulerControl = (L.control.ruler = function (options) {
