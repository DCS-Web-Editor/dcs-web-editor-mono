...
const component: Component = {
  ...
  render: (c: Context) => {
    ...
    return `QNH: ${weather.qnh} TEMP: ${weather.season.temperature.toFixed(1)}° ${((weather.season.temperature * 9 / 5) + 32).toFixed(1)}F VISIBILITY: ${weather.visibility.distance}m
<b>CLOUD</b> BASE ${weather.clouds.base}m THICKNESS ${weather.clouds.thickness}
