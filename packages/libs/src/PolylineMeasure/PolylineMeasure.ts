            ...
            if (this._measuring) {
                ...
                if (this._measureControl) {
                    ...
                    this._measureControl.style.backgroundColor =
                        this._defaultControlBgColor;
                    this._measureControl.title =
                        this.options.measureControlTitleOn;
                }
                    ...
                    if (this.options.showBearings === true) {
                        text =
                            ...
                            (this.options.bearingTextOut
                                ? "<br>" + this.options.bearingTextOut + ":---°"
                                : "");
                    }
                    text =
                        text +
            ...
            this._currentLine = {
                ...
                addPoint: function (mouseCoords) {
                    ...
                    if (this.circleCoords.length > 1) {
                        ...
                        var arrowMarker;
                        if (!polylineState.options.simple)
                            arrowMarker = polylineState._drawArrow(arc);
                ...
                finalize: function () {
                    ...
                    if (
                        this.circleCoords.length > 1 &&
                        !polylineState.options.simple
                    ) {
                        this.tooltips
                            .last()
                            ._icon.classList.add(
