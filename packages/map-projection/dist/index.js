...
const config = {
    ...
    Caucasus: {
        central_meridian: 33,
        false_easting: -99517,
        false_northing: -4998115,
        scale_factor: 0.9996,
    },
    Falklands: {
        central_meridian: -57,
        false_easting: 147640,
        false_northing: 5815417,
        scale_factor: 0.9996,
    },
    MarianaIslands: {
        central_meridian: 147,
        false_easting: 238418,
        false_northing: -1491840,
        scale_factor: 0.9996,
    },
    MarianaIslandsWWII: {
        central_meridian: 147,
    ...
    Nevada: {
        ...
        false_easting: -193996.81,
        false_northing: -4410028.064,
        scale_factor: 0.9996,
    },
    PersianGulf: {
        central_meridian: 57,
        false_easting: 75756,
        false_northing: -2894933,
        scale_factor: 0.9996,
    },
    Normandy: {
        central_meridian: -3,
        false_easting: -195526,
        false_northing: -5484813,
        scale_factor: 0.9996,
    },
    TheChannel: {
        central_meridian: 3,
        false_easting: 99376,
        false_northing: -5636889,
        scale_factor: 0.9996,
    },
    TopEndAustralia: {
...
export function calcRotationOffset(marker, project) {
